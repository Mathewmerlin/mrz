...
td3_generator = TD3CodeGenerator("P",            # Document type   Normally 'P' for passport
                                 ...
                                 "JHON",       # Surname(s)      Special characters will be transliterated
                                 "FERNANDO",        # Given name(s)   Special characters will be transliterated
                                 "980XG47",      # Passport number
                                 "GBR",          # Nationality     3 letter code or country name
                                 "760316",       # Birth date      YYMMDD
...
td3_generator.expiry_date = "230124"
